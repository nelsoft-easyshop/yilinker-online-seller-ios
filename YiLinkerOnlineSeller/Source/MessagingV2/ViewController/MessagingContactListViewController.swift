...
class MessagingContactListViewController: UIViewController {
    ...
    func showHUD() {
        ...
        self.yiHud = MBProgressHUD(view: self.view)
        self.yiHud?.removeFromSuperViewOnHide = true
        self.yiHud?.dimBackground = false
        self.view.addSubview(self.yiHud!)
        self.yiHud?.show(true)
    }
