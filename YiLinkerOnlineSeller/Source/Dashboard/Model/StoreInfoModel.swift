    ...
    class func parseSellerDataFromDictionary(dictionary: NSDictionary) -> StoreInfoModel {
        ...
        if let value: AnyObject = dictionary["data"] {
            ...
            if let user_id = value["userId"] as? String {
                userId = user_id
            } else if let user_id = value["userId"] as? Int {
                userId = "\(user_id)"
            } else {
                userId = ""
            }
