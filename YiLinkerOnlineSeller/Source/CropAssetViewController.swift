...
class CropAssetViewController: UIViewController, UIScrollViewDelegate {
    ...
    func check(){
        dispatch_async(dispatch_get_main_queue(), {
            ...
            faImagePicker.image = cropImage
            faImagePicker.shouldBeDone()
...
//        println("imageFrameSize:\(imageFrameSize)")
    ...
    @IBAction func doneButtonAction(sender: UIBarButtonItem) {
        ...
        self.croppedImages.append(cropImage)
        println(self.croppedImages.count)
        ProductUploadStrings.cropped.insert(cropImage, atIndex: ProductUploadStrings.cropped.count - 1)
        ...
        //let cropper: CropperViewController = CropperViewController(nibName: "CropperViewController", bundle: nil)
