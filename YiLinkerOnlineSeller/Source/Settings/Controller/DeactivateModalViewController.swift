    ...
    @IBAction func buttonAction(sender: AnyObject) {
        if sender as! UIButton == closeButton {
            ...
            if passwordTextField.isNotEmpty() {
                ...
                UIAlertController.displayErrorMessageWithTarget(self, errorMessage: passwordRequiredString, title: self.errorLocalizeString)
            }
        }
    }
        ...
        manager.POST(url, parameters: params, success: {
            ...
            if responseObject.objectForKey("error") != nil {
                ...
                if responseObject["isSuccessful"] as! Bool {
                    ...
                    UIAlertController.displayErrorMessageWithTarget(self, errorMessage: responseObject["message"] as! String, title: self.errorLocalizeString)
                    self.dismissLoader()
                }
            }
