...
class TransactionDetailsTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var dateModifiedTitleLabel: UILabel!
    ...
    func intializeLocalizedStrings() {
        ...
        dateModifiedLabel.text = StringHelper.localizedStringWithKey("TRANSACTION_DETAILS_DATE_MODIFIED_LOCALIZE_KEY")
