...
struct ProductUploadImageTVCConstant {
    static let productUploadImageCollectionViewCellNibNameAndIdentifier = "ProductUploadImageTVC"
}

// MARK: Data source
// ProductUploadUploadImageTableViewCell Data source methods
protocol ProductUploadImageTVCDataSource {
...
protocol ProductUploadImageTVCDelegate {
...
class ProductUploadImageTVC: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate, ProductUploadImageCollectionViewCellDelegate {
    ...
    var dataSource: ProductUploadImageTVCDataSource?
    var delegate: ProductUploadImageTVCDelegate?
    ...
    func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 3 //self.dataSource!.productUploadUploadImageTableViewCell(numberOfCollectionViewRows: self)
    }
