...
struct APIAtlas {
    ...
    static let provinceUrl = APIAtlas.generateV3URL("auth/location/getAllProvinces?access_token=")
    static let citiesUrl = APIAtlas.generateV3URL("auth/location/getChildCities")
    static let barangay = APIAtlas.generateV3URL("auth/location/getBarangaysByCity")
    ...
    static let updateInventory = APIAtlas.generateV3URL("auth/warehouse/inventory/update?access_token=")
